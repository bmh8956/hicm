				...
				<div class="container">
					<div class="row">
						<div class="col-lg-2 col-md-2 col-12">
							<!-- Logo -->
							<div class="logo">
								<a href="/hicommunity"><img src="static/user/images/logo_11.png" alt="logo"></a>
							</div>
							<!--/ End Logo -->
							<!-- Search Form -->
											...
											<div class="nav-inner">	
												<ul class="nav main-menu menu navbar-nav">
													<li class="active"><a href="#">Home<i class="ti-angle-down"></i></a>
														<ul class="dropdown">
															<li><a href="/hicommunity">Home Ecommerce V1</a></li>
															<li><a href="index2.html">Home Ecommerce V2</a></li>
															<li><a href="index3.html">Home Ecommerce V3</a></li>
															<li><a href="/hicommunity">Home Ecommerce V4</a></li>
														</ul>
													</li>
													...
													<li><a href="#">Pages<i class="ti-angle-down"></i></a>
														<ul class="dropdown">
															...
															<li><a href="mail-success.jsp">Mail Success</a></li>
									...
									<div class="product-gallery">
										<div class="quickview-slider-active">
											<div class="single-slider">
												<img src="static/user/images/modal1.jpg" alt="#">
											</div>
											<div class="single-slider">
												<img src="static/user/images/modal2.jpg" alt="#">
											</div>
											<div class="single-slider">
												<img src="static/user/images/modal3.jpg" alt="#">
											</div>
											<div class="single-slider">
												<img src="static/user/images/modal4.jpg" alt="#">
											</div>
										</div>
									</div>
								<!-- End Product slider -->
