...
<!-- End Breadcrumbs -->
<%
    String list_type = (String) request.getAttribute("list_type");
	list_type = "my";
...
<script>
    let get_list = (type, page) => {
        ...
        $.ajax({
                ...
                success: function (res) {
                    ...
                    if(res.msg === 'success') {
                        for(let bd of res.list) {
                            html += '<tr>' +
                                        ...
                                        '<td class="product-des content" data-title="Description">' +
                                            '<p class="product-des">' + bd.bd_title +'</p>' +
                                        '</td>' +
                    ...
                    paging(Number(res.count), JSON.parse(res.paging));
                }
            });
    }
    ...
    window.onload = () => {
        get_list(document.getElementById("list_type").value, 1);
